...
export class EditProductComponent implements OnInit {
  ...
  constructor( private route:ActivatedRoute,public prodService : ProductService,private fb: UntypedFormBuilder) {
    ...
    this.prodService.getProduct(this.productId).subscribe({
      next:(product)=>{
        ...
        this.productFormGroup = this.fb.group({
          ...
          price: this.fb.control(this.product.price, [Validators.required,Validators.min(50)]),
